...
class AiServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(AiToolRegistry::class, function ($app) {
            ...
            //
            // try {
            //     $registry->register($app->make(\App\Services\AI\Tools\CreateCustomerTool::class));
            // } catch (\Throwable $e) {
            //     Log::warning('[AI] Gagal mendaftarkan CreateCustomerTool, dilewati.', ['error' => $e->getMessage()]);
            // }
